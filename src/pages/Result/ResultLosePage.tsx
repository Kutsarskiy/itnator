...
import homeMascot from "@/assets/mascot/Lost.png";
import specialtiesData from "@/data/specialties.json";
import { ROUTES } from "@/app/routes";
import { Button } from "@/components/ui/button";
import { useQuizStore } from "@/store/quizStore";
import { getRanking } from "@/core/scoring/scoring";
...
export function ResultLosePage() {
          ...
          >
            ...
            <div className="relative z-10 flex h-full flex-col p-7 md:p-8">
              <div>
                ...
                >
                  Я не зміг впевнено вгадати за 15 питань
                </h1>

                <p
                  className="itn-stagger mt-4 text-[15px] leading-relaxed text-slate-700/85"
                  style={{ animationDelay: "290ms" }}
                >
                  Але ось{" "}
                  <span className="font-semibold text-slate-900">топ-3</span>{" "}
                  спеціальності за твоїми відповідями:
                </p>

                <div
                  className="itn-stagger mt-6 overflow-hidden rounded-2xl border border-white/30 bg-white/18 backdrop-blur-2xl"
                  ...
                  {top3.map((s, idx) => (
                    <div key={s.id}>
                      ...
                      >
                        ...
                        <div className="mt-1 text-[17px] font-semibold text-slate-900/90">
                          {s.nameUk}
                        </div>
                        <div className="mt-2 text-[15px] leading-relaxed text-slate-700/80">
                          {s.shortUk}
                        </div>
              ...
              <div className="itn-stagger" style={{ animationDelay: "700ms" }}>
                ...
                <div className="mt-6 text-center text-xs text-slate-700/65">
                  Спробуй пройти тест ще раз — я підлаштуюсь під твої відповіді
                  й обовʼязково вгадаю, яка спеціальність тобі підходить 😉
                </div>
              </div>
            </div>
          </div>
